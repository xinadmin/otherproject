<template>
    <el-input placeholder="请输入内容" v-model="value" class="input-with-select" size="small">
        <el-select class="foneSel" v-model="selectValue" slot="prepend" placeholder="请选择" @change="handleChange" size="small">
