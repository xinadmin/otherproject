    ...
    <div class="contract-container">
        <el-row :gutter="24">
            <el-col class="flex_center_between" :span="6">
                <span class="select_title">会员类型:</span>
            ...
            <el-col class="flex_center_between" :span="5">
                <span class="select_title">会员账号:</span>
                <el-input placeholder="请输入会员账号" v-model="rentalSite"/>
            </el-col>
            <el-col class="flex_center_between" :span="5">
                <span class="select_title">会员昵称:</span>
                <el-input placeholder="请输入会员昵称" v-model="lessee"/>
            </el-col>
